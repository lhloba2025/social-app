...
export default function BulkImageGen({ ar }) {
  ...
  const downloadTemplate = () => {
    const headers = ["وصف المشهد", "الهوك", "الكلمات المميزة", "الكابشن", "انستقرام", "فيسبوك", "تيك توك", "استوري", "تويتر", "لينكدإن", "يوتيوب"];
    const ex = [
      ...
      "1080×1350 (4:5)", "1080×1350 (4:5)", "1080×1920 (9:16)", "1080×1920 (9:16)", "1080×1350 (4:5)", "1080×1350 (4:5)", "",
    ];
    const ws = XLSX.utils.aoa_to_sheet([headers, ex]);
    ws["!cols"] = [{ wch: 45 }, { wch: 26 }, { wch: 16 }, { wch: 42 }, { wch: 16 }, { wch: 16 }, { wch: 16 }, { wch: 16 }, { wch: 16 }, { wch: 16 }, { wch: 16 }];
