...
export const REAL_IMAGE_CATEGORIES = [
  ...
  {
    ar: "🛒 سوبرماركت وعرض المنتجات", en: "Supermarket & Merchandising",
    items: [
      { ar: "رف سوبرماركت",  en: "Supermarket shelf", emoji: "🗄️", query: "supermarket shelf gondola rack png transparent" },
      { ar: "رفوف معبأة",    en: "Stocked shelves",  emoji: "🏪", query: "supermarket stocked shelves aisle png transparent" },
      { ar: "عربة تسوق",     en: "Shopping cart",    emoji: "🛒", query: "shopping cart trolley png transparent" },
      { ar: "سلة تسوق",      en: "Shopping basket",  emoji: "🧺", query: "shopping basket png transparent" },
      { ar: "باركود",        en: "Barcode",          emoji: "▦",  query: "barcode label png transparent" },
      { ar: "بطاقة سعر",     en: "Price tag",        emoji: "🏷️", query: "retail price tag shelf label png transparent" },
      { ar: "صندوق منتجات",  en: "Product box",      emoji: "📦", query: "product carton box png transparent" },
      { ar: "معلبات",        en: "Canned goods",     emoji: "🥫", query: "canned food tin can png transparent" },
      { ar: "زجاجة منتج",    en: "Bottle product",   emoji: "🧴", query: "consumer product bottle png transparent" },
      { ar: "ثلاجة عرض",     en: "Display cooler",   emoji: "🧊", query: "supermarket display cooler fridge png transparent" },
      { ar: "مجمّد",         en: "Freezer",          emoji: "❄️", query: "supermarket chest freezer png transparent" },
      { ar: "كاشير / POS",   en: "Cashier / POS",    emoji: "💳", query: "cashier pos checkout counter png transparent" },
      { ar: "ستاند عرض",     en: "Display stand",    emoji: "🪧", query: "retail pop display stand png transparent" },
      { ar: "بالة بضائع",    en: "Pallet of goods",  emoji: "🟫", query: "warehouse pallet stacked boxes png transparent" },
      { ar: "خضار وفواكه",   en: "Produce stand",    emoji: "🥬", query: "supermarket fruit vegetable stand png transparent" },
      { ar: "عربة تموين",    en: "Stock trolley",    emoji: "🛍️", query: "merchandiser stocking trolley png transparent" },
      { ar: "بلانوجرام",     en: "Planogram",        emoji: "📐", query: "retail planogram shelf layout diagram png transparent" },
      { ar: "مخزن",          en: "Warehouse",        emoji: "🏭", query: "warehouse storage racks png transparent" },
    ],
  },
  {
